...
\label{debugmalloc_8h_source}\textbf{ Go to the documentation of this file.}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ putenv(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *);}
...
\DoxyCodeLine{00047\ \ \ \ \ \textcolor{keywordtype}{int}\ putenv(\textcolor{keywordtype}{char}\ *);}
\DoxyCodeLine{00048\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00049\ }
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ \textcolor{comment}{/*\ linked\ list\ entry\ for\ allocated\ blocks\ */}}
\DoxyCodeLine{00052\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }DebugmallocEntry\ \{}
\DoxyCodeLine{00053\ \ \ \ \ \textcolor{keywordtype}{void}\ *real\_mem;\ \ \ \ \ \textcolor{comment}{/*\ the\ address\ of\ the\ real\ allocation\ */}}
\DoxyCodeLine{00054\ \ \ \ \ \textcolor{keywordtype}{void}\ *user\_mem;\ \ \ \ \ \textcolor{comment}{/*\ address\ shown\ to\ the\ user\ */}}
\DoxyCodeLine{00055\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ size;\ \ \ \ \ \ \ \ \textcolor{comment}{/*\ size\ of\ block\ requested\ by\ user\ */}}
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keywordtype}{char}\ file[64];\ \ \ \ \ \ \textcolor{comment}{/*\ malloc\ called\ in\ this\ file\ */}}
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ line;\ \ \ \ \ \ \textcolor{comment}{/*\ malloc\ called\ at\ this\ line\ in\ file\ */}}
\DoxyCodeLine{00059\ \ \ \ \ \textcolor{keywordtype}{char}\ func[32];\ \ \ \ \ \ \textcolor{comment}{/*\ allocation\ function\ called\ (malloc,\ calloc,\ realloc)\ */}}
\DoxyCodeLine{00060\ \ \ \ \ \textcolor{keywordtype}{char}\ expr[128];\ \ \ \ \ \textcolor{comment}{/*\ expression\ calculating\ the\ size\ of\ allocation\ */}}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \ \ \ \ \textcolor{keyword}{struct\ }DebugmallocEntry\ *prev,\ *next;\ \ \textcolor{comment}{/*\ for\ doubly\ linked\ list\ */}}
\DoxyCodeLine{00063\ \}\ DebugmallocEntry;}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \textcolor{comment}{/*\ debugmalloc\ singleton,\ storing\ all\ state\ */}}
\DoxyCodeLine{00067\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }DebugmallocData\ \{}
\DoxyCodeLine{00068\ \ \ \ \ \textcolor{keywordtype}{char}\ logfile[256];\ \ \ \ \textcolor{comment}{/*\ log\ file\ name\ or\ empty\ string\ */}}
\DoxyCodeLine{00069\ \ \ \ \ \textcolor{keywordtype}{long}\ max\_block\_size;\ \ \textcolor{comment}{/*\ max\ size\ of\ a\ single\ block\ allocated\ */}}
\DoxyCodeLine{00070\ \ \ \ \ \textcolor{keywordtype}{long}\ alloc\_count;\ \ \ \ \ \textcolor{comment}{/*\ currently\ allocated;\ decreased\ with\ free\ */}}
\DoxyCodeLine{00071\ \ \ \ \ \textcolor{keywordtype}{long}\ \textcolor{keywordtype}{long}\ alloc\_bytes;}
\DoxyCodeLine{00072\ \ \ \ \ \textcolor{keywordtype}{long}\ all\_alloc\_count;\ \textcolor{comment}{/*\ all\ allocations,\ never\ decreased\ */}}
\DoxyCodeLine{00073\ \ \ \ \ \textcolor{keywordtype}{long}\ \textcolor{keywordtype}{long}\ all\_alloc\_bytes;}
\DoxyCodeLine{00074\ \ \ \ \ DebugmallocEntry\ head[debugmalloc\_tablesize],\ tail[debugmalloc\_tablesize];\ \ \textcolor{comment}{/*\ head\ and\ tail\ elements\ of\ allocation\ lists\ */}}
\DoxyCodeLine{00075\ \}\ DebugmallocData;}
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00078\ \textcolor{comment}{/*\ this\ forward\ declaration\ is\ required\ by\ the\ singleton\ manager\ function\ */}}
\DoxyCodeLine{00079\ \textcolor{keyword}{static}\ DebugmallocData\ *\ debugmalloc\_create(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00081\ }
...
\DoxyCodeLine{00088\ \textcolor{keyword}{static}\ DebugmallocData\ *\ debugmalloc\_singleton(\textcolor{keywordtype}{void})\ \{}
...
\DoxyCodeLine{00112\ \ \ \ \ \}}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00114\ \ \ \ \ \textcolor{keywordflow}{return}\ (DebugmallocData\ *)\ instance;}
\DoxyCodeLine{00115\ \}}
\DoxyCodeLine{00116\ }
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00118\ \textcolor{comment}{/*\ better\ version\ of\ strncpy,\ always\ terminates\ string\ with\ \(\backslash\)0.\ */}}
\DoxyCodeLine{00119\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_strlcpy(\textcolor{keywordtype}{char}\ *dest,\ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *src,\ \textcolor{keywordtype}{size\_t}\ destsize)\ \{}
...
\DoxyCodeLine{00127\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_log\_file(\textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *logfilename)\ \{}
\DoxyCodeLine{00128\ \ \ \ \ \textcolor{keywordflow}{if}\ (logfilename\ ==\ NULL)}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ logfilename\ =\ \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{00130\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00131\ \ \ \ \ debugmalloc\_strlcpy(instance-\/>logfile,\ logfilename,\ \textcolor{keyword}{sizeof}(instance-\/>logfile));}
\DoxyCodeLine{00132\ \}}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ }
\DoxyCodeLine{00135\ \textcolor{comment}{/*\ set\ the\ maximum\ size\ of\ one\ block.\ useful\ for\ debugging\ purposes.\ */}}
\DoxyCodeLine{00136\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_max\_block\_size(\textcolor{keywordtype}{long}\ max\_block\_size)\ \{}
\DoxyCodeLine{00137\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00138\ \ \ \ \ instance-\/>max\_block\_size\ =\ max\_block\_size;}
\DoxyCodeLine{00139\ \}}
\DoxyCodeLine{00140\ }
\DoxyCodeLine{00141\ }
\DoxyCodeLine{00142\ }
\DoxyCodeLine{00143\ \textcolor{comment}{/*\ printf\ to\ the\ log\ file,\ or\ stderr.\ */}}
\DoxyCodeLine{00144\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_log(\textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *format,\ ...)\ \{}
\DoxyCodeLine{00145\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00146\ \ \ \ \ FILE\ *f\ =\ stderr;}
\DoxyCodeLine{00147\ \ \ \ \ \textcolor{keywordflow}{if}\ (instance-\/>logfile[0]\ !=\ \textcolor{charliteral}{'\(\backslash\)0'})\ \{}
\DoxyCodeLine{00148\ \ \ \ \ \ \ \ \ f\ =\ fopen(instance-\/>logfile,\ \textcolor{stringliteral}{"{}at"{}});}
\DoxyCodeLine{00149\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (f\ ==\ NULL)\ \{}
\DoxyCodeLine{00150\ \ \ \ \ \ \ \ \ \ \ \ \ f\ =\ stderr;}
\DoxyCodeLine{00151\ \ \ \ \ \ \ \ \ \ \ \ \ fprintf(stderr,\ \textcolor{stringliteral}{"{}debugmalloc:\ nem\ tudom\ megnyitni\ a\ \%s\ fajlt\ irasra!\(\backslash\)n"{}},\ instance-\/>logfile);}
\DoxyCodeLine{00152\ \ \ \ \ \ \ \ \ \ \ \ \ debugmalloc\_strlcpy(instance-\/>logfile,\ \textcolor{stringliteral}{"{}"{}},\ \textcolor{keyword}{sizeof}(instance-\/>logfile));}
\DoxyCodeLine{00153\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00154\ \ \ \ \ \}}
\DoxyCodeLine{00155\ }
...
\DoxyCodeLine{00170\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_memory\_init(DebugmallocEntry\ *elem,\ \textcolor{keywordtype}{bool}\ zero)\ \{}
\DoxyCodeLine{00171\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *real\_mem\ =\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *)\ elem-\/>real\_mem;}
\DoxyCodeLine{00172\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *user\_mem\ =\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *)\ elem-\/>user\_mem;}
\DoxyCodeLine{00173\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *canary1\ =\ real\_mem;}
\DoxyCodeLine{00174\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *canary2\ =\ real\_mem\ +\ debugmalloc\_canary\_size\ +\ elem-\/>size;}
\DoxyCodeLine{00175\ \ \ \ \ memset(canary1,\ debugmalloc\_canary\_char,\ debugmalloc\_canary\_size);}
\DoxyCodeLine{00176\ \ \ \ \ memset(canary2,\ debugmalloc\_canary\_char,\ debugmalloc\_canary\_size);}
\DoxyCodeLine{00177\ \ \ \ \ memset(user\_mem,\ zero\ ?\ 0\ :\ debugmalloc\_canary\_char,\ elem-\/>size);}
\DoxyCodeLine{00178\ \}}
\DoxyCodeLine{00179\ }
\DoxyCodeLine{00180\ \textcolor{comment}{/*\ check\ canary,\ return\ true\ if\ ok,\ false\ if\ corrupted.\ */}}
\DoxyCodeLine{00181\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{bool}\ debugmalloc\_canary\_ok(DebugmallocEntry\ \textcolor{keyword}{const}\ *elem)\ \{}
\DoxyCodeLine{00182\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *real\_mem\ =\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *)\ elem-\/>real\_mem;}
\DoxyCodeLine{00183\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *canary1\ =\ real\_mem;}
\DoxyCodeLine{00184\ \ \ \ \ \textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *canary2\ =\ real\_mem\ +\ debugmalloc\_canary\_size\ +\ elem-\/>size;}
\DoxyCodeLine{00185\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ i\ =\ 0;\ i\ <\ debugmalloc\_canary\_size;\ ++i)\ \{}
\DoxyCodeLine{00186\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (canary1[i]\ !=\ debugmalloc\_canary\_char)}
\DoxyCodeLine{00187\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{00188\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (canary2[i]\ !=\ debugmalloc\_canary\_char)}
...
\DoxyCodeLine{00196\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_dump\_memory(\textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *mem,\ \textcolor{keywordtype}{size\_t}\ size)\ \{}
...
\DoxyCodeLine{00215\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00216\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00217\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}\%s\(\backslash\)n"{}},\ line);}
\DoxyCodeLine{00218\ \ \ \ \ \}}
\DoxyCodeLine{00219\ \}}
\DoxyCodeLine{00220\ }
\DoxyCodeLine{00221\ }
...
\DoxyCodeLine{00224\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_dump\_elem(DebugmallocEntry\ \textcolor{keyword}{const}\ *elem)\ \{}
\DoxyCodeLine{00225\ \ \ \ \ \textcolor{keywordtype}{bool}\ canary\_ok\ =\ debugmalloc\_canary\_ok(elem);}
\DoxyCodeLine{00226\ }
\DoxyCodeLine{00227\ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}\ \ \%p,\ \%u\ bajt,\ kanari:\ \%s\(\backslash\)n"{}}}
\DoxyCodeLine{00228\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}\ \ \%s:\%u,\ \%s(\%s)\(\backslash\)n"{}},}
\DoxyCodeLine{00229\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ elem-\/>user\_mem,\ (\textcolor{keywordtype}{unsigned})\ elem-\/>size,\ canary\_ok\ ?\ \textcolor{stringliteral}{"{}ok"{}}\ :\ \textcolor{stringliteral}{"{}**SERULT**"{}},}
\DoxyCodeLine{00230\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ elem-\/>file,\ elem-\/>line,}
\DoxyCodeLine{00231\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ elem-\/>func,\ elem-\/>expr);}
\DoxyCodeLine{00232\ }
\DoxyCodeLine{00233\ \ \ \ \ \textcolor{keywordflow}{if}\ (!canary\_ok)\ \{}
\DoxyCodeLine{00234\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}\ \ \ \ ELOTTE\ kanari:\ \(\backslash\)n"{}});}
\DoxyCodeLine{00235\ \ \ \ \ \ \ \ \ debugmalloc\_dump\_memory((\textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *)\ elem-\/>real\_mem,\ debugmalloc\_canary\_size);}
\DoxyCodeLine{00236\ \ \ \ \ \}}
\DoxyCodeLine{00237\ }
\DoxyCodeLine{00238\ \ \ \ \ debugmalloc\_dump\_memory((\textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *)\ elem-\/>user\_mem,\ elem-\/>size\ >\ 64\ ?\ 64\ :\ elem-\/>size);}
\DoxyCodeLine{00239\ }
\DoxyCodeLine{00240\ \ \ \ \ \textcolor{keywordflow}{if}\ (!canary\_ok)\ \{}
\DoxyCodeLine{00241\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}\ \ \ \ UTANA\ kanari:\ \(\backslash\)n"{}});}
\DoxyCodeLine{00242\ \ \ \ \ \ \ \ \ debugmalloc\_dump\_memory((\textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *)\ elem-\/>real\_mem\ +\ debugmalloc\_canary\_size\ +\ elem-\/>size,\ debugmalloc\_canary\_size);}
\DoxyCodeLine{00243\ \ \ \ \ \}}
\DoxyCodeLine{00244\ \}}
\DoxyCodeLine{00245\ }
\DoxyCodeLine{00246\ }
\DoxyCodeLine{00247\ \textcolor{comment}{/*\ dump\ data\ of\ all\ memory\ blocks\ allocated.\ */}}
\DoxyCodeLine{00248\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_dump(\textcolor{keywordtype}{void})\ \{}
\DoxyCodeLine{00249\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00250\ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}**\ DEBUGMALLOC\ DUMP\ ************************************\(\backslash\)n"{}});}
\DoxyCodeLine{00251\ \ \ \ \ \textcolor{keywordtype}{int}\ cnt\ =\ 0;}
\DoxyCodeLine{00252\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ i\ =\ 0;\ i\ <\ debugmalloc\_tablesize;\ i++)\ \{}
\DoxyCodeLine{00253\ \ \ \ \ \ \ \ \ DebugmallocEntry\ *head\ =\ \&instance-\/>head[i];}
\DoxyCodeLine{00254\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (DebugmallocEntry\ *iter\ =\ head-\/>next;\ iter-\/>next\ !=\ NULL;\ iter\ =\ iter-\/>next)\ \{}
\DoxyCodeLine{00255\ \ \ \ \ \ \ \ \ \ \ \ \ ++cnt;}
\DoxyCodeLine{00256\ \ \ \ \ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}**\ \%d/\%d.\ rekord:\(\backslash\)n"{}},\ cnt,\ instance-\/>alloc\_count);}
\DoxyCodeLine{00257\ \ \ \ \ \ \ \ \ \ \ \ \ debugmalloc\_dump\_elem(iter);}
\DoxyCodeLine{00258\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00259\ \ \ \ \ \}}
\DoxyCodeLine{00260\ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}**\ DEBUGMALLOC\ DUMP\ VEGE\ *******************************\(\backslash\)n"{}});}
\DoxyCodeLine{00261\ \}}
\DoxyCodeLine{00262\ }
\DoxyCodeLine{00263\ }
...
\DoxyCodeLine{00266\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_atexit\_dump(\textcolor{keywordtype}{void})\ \{}
\DoxyCodeLine{00267\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00268\ \ \ \ \ }
\DoxyCodeLine{00269\ \ \ \ \ \textcolor{keywordflow}{if}\ (instance-\/>alloc\_count\ >\ 0)\ \{}
\DoxyCodeLine{00270\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
...
\DoxyCodeLine{00275\ \ \ \ \ \ \ \ \ debugmalloc\_dump();}
\DoxyCodeLine{00276\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00277\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}****************************************************\(\backslash\)n"{}}}
...
\DoxyCodeLine{00281\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ instance-\/>all\_alloc\_count,\ instance-\/>all\_alloc\_bytes);}
\DoxyCodeLine{00282\ \ \ \ \ \}}
\DoxyCodeLine{00283\ \}}
\DoxyCodeLine{00284\ }
\DoxyCodeLine{00285\ }
\DoxyCodeLine{00286\ \textcolor{comment}{/*\ hash\ function\ for\ bucket\ hash.\ */}}
\DoxyCodeLine{00287\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{size\_t}\ debugmalloc\_hash(\textcolor{keywordtype}{void}\ *address)\ \{}
...
\DoxyCodeLine{00291\ \ \ \ \ \textcolor{keywordflow}{return}\ cut\ \%\ debugmalloc\_tablesize;}
\DoxyCodeLine{00292\ \}}
\DoxyCodeLine{00293\ }
\DoxyCodeLine{00294\ }
\DoxyCodeLine{00295\ \textcolor{comment}{/*\ insert\ element\ to\ hash\ table.\ */}}
\DoxyCodeLine{00296\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_insert(DebugmallocEntry\ *entry)\ \{}
\DoxyCodeLine{00297\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00298\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ idx\ =\ debugmalloc\_hash(entry-\/>user\_mem);}
\DoxyCodeLine{00299\ \ \ \ \ DebugmallocEntry\ *head\ =\ \&instance-\/>head[idx];}
\DoxyCodeLine{00300\ \ \ \ \ entry-\/>prev\ =\ head;}
\DoxyCodeLine{00301\ \ \ \ \ entry-\/>next\ =\ head-\/>next;}
\DoxyCodeLine{00302\ \ \ \ \ head-\/>next-\/>prev\ =\ entry;}
\DoxyCodeLine{00303\ \ \ \ \ head-\/>next\ =\ entry;}
\DoxyCodeLine{00304\ \ \ \ \ instance-\/>alloc\_count\ +=\ 1;}
\DoxyCodeLine{00305\ \ \ \ \ instance-\/>alloc\_bytes\ +=\ entry-\/>size;}
\DoxyCodeLine{00306\ \ \ \ \ instance-\/>all\_alloc\_count\ +=\ 1;}
\DoxyCodeLine{00307\ \ \ \ \ instance-\/>all\_alloc\_bytes\ +=\ entry-\/>size;}
\DoxyCodeLine{00308\ \}}
\DoxyCodeLine{00309\ }
\DoxyCodeLine{00310\ }
\DoxyCodeLine{00311\ \textcolor{comment}{/*\ remove\ element\ from\ hash\ table\ */}}
\DoxyCodeLine{00312\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_remove(DebugmallocEntry\ *entry)\ \{}
\DoxyCodeLine{00313\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00314\ \ \ \ \ entry-\/>next-\/>prev\ =\ entry-\/>prev;}
\DoxyCodeLine{00315\ \ \ \ \ entry-\/>prev-\/>next\ =\ entry-\/>next;}
\DoxyCodeLine{00316\ \ \ \ \ instance-\/>alloc\_count\ -\/=\ 1;}
\DoxyCodeLine{00317\ \ \ \ \ instance-\/>alloc\_bytes\ -\/=\ entry-\/>size;}
\DoxyCodeLine{00318\ \}}
\DoxyCodeLine{00319\ }
\DoxyCodeLine{00320\ }
...
\DoxyCodeLine{00323\ \textcolor{keyword}{static}\ DebugmallocEntry\ *debugmalloc\_find(\textcolor{keywordtype}{void}\ *mem)\ \{}
\DoxyCodeLine{00324\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00325\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ idx\ =\ debugmalloc\_hash(mem);}
\DoxyCodeLine{00326\ \ \ \ \ DebugmallocEntry\ *head\ =\ \&instance-\/>head[idx];}
\DoxyCodeLine{00327\ \ \ \ \ \textcolor{keywordflow}{for}\ (DebugmallocEntry\ *iter\ =\ head-\/>next;\ iter-\/>next\ !=\ NULL;\ iter\ =\ iter-\/>next)}
...
\DoxyCodeLine{00341\ \ \ \ \ DebugmallocData\ *instance\ =\ debugmalloc\_singleton();}
\DoxyCodeLine{00342\ \ \ \ \ \textcolor{keywordflow}{if}\ (size\ >\ (\textcolor{keywordtype}{size\_t})(instance-\/>max\_block\_size))\ \{}
\DoxyCodeLine{00343\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ a\ blokk\ merete\ tul\ nagy,\ \%u\ bajt;\ debugmalloc\_max\_block\_size()\ fuggvennyel\ novelheto.\(\backslash\)n"{}},\ func,\ file,\ line,\ (\textcolor{keywordtype}{unsigned})\ size);}
\DoxyCodeLine{00344\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00345\ \ \ \ \ \}}
\DoxyCodeLine{00346\ }
\DoxyCodeLine{00347\ \ \ \ \ \textcolor{comment}{/*\ allocate\ more\ memory,\ make\ room\ for\ canary\ */}}
\DoxyCodeLine{00348\ \ \ \ \ \textcolor{keywordtype}{void}\ *real\_mem\ =\ malloc(size\ +\ 2\ *\ debugmalloc\_canary\_size);}
\DoxyCodeLine{00349\ \ \ \ \ \textcolor{keywordflow}{if}\ (real\_mem\ ==\ NULL)\ \{}
\DoxyCodeLine{00350\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ nem\ sikerult\ \%u\ meretu\ memoriat\ foglalni!\(\backslash\)n"{}},\ func,\ file,\ line,\ (\textcolor{keywordtype}{unsigned})\ size);}
...
\DoxyCodeLine{00355\ \ \ \ \ DebugmallocEntry\ *newentry\ =\ (DebugmallocEntry\ *)\ malloc(\textcolor{keyword}{sizeof}(DebugmallocEntry));}
\DoxyCodeLine{00356\ \ \ \ \ \textcolor{keywordflow}{if}\ (newentry\ ==\ NULL)\ \{}
\DoxyCodeLine{00357\ \ \ \ \ \ \ \ \ free(real\_mem);}
\DoxyCodeLine{00358\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ le\ tudtam\ foglalni\ \%u\ memoriat,\ de\ utana\ a\ sajatnak\ nem,\ sry\(\backslash\)n"{}},\ func,\ file,\ line,\ (\textcolor{keywordtype}{unsigned})\ size);}
\DoxyCodeLine{00359\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00360\ \ \ \ \ \}}
\DoxyCodeLine{00361\ }
\DoxyCodeLine{00362\ \ \ \ \ \textcolor{comment}{/*\ metadata\ of\ allocation:\ caller\ function,\ code\ line\ etc.\ */}}
\DoxyCodeLine{00363\ \ \ \ \ debugmalloc\_strlcpy(newentry-\/>func,\ func,\ \textcolor{keyword}{sizeof}(newentry-\/>func));}
\DoxyCodeLine{00364\ \ \ \ \ debugmalloc\_strlcpy(newentry-\/>expr,\ expr,\ \textcolor{keyword}{sizeof}(newentry-\/>expr));}
\DoxyCodeLine{00365\ \ \ \ \ debugmalloc\_strlcpy(newentry-\/>file,\ file,\ \textcolor{keyword}{sizeof}(newentry-\/>file));}
\DoxyCodeLine{00366\ \ \ \ \ newentry-\/>line\ =\ line;}
\DoxyCodeLine{00367\ }
\DoxyCodeLine{00368\ \ \ \ \ \textcolor{comment}{/*\ address\ of\ allocated\ memory\ chunk\ */}}
\DoxyCodeLine{00369\ \ \ \ \ newentry-\/>real\_mem\ =\ real\_mem;}
\DoxyCodeLine{00370\ \ \ \ \ newentry-\/>user\_mem\ =\ (\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}\ *)\ real\_mem\ +\ debugmalloc\_canary\_size;}
\DoxyCodeLine{00371\ \ \ \ \ newentry-\/>size\ =\ size;}
\DoxyCodeLine{00372\ \ \ \ \ debugmalloc\_memory\_init(newentry,\ zero);}
\DoxyCodeLine{00373\ }
\DoxyCodeLine{00374\ \ \ \ \ \textcolor{comment}{/*\ store\ in\ list\ and\ return\ pointer\ to\ user\ area\ */}}
\DoxyCodeLine{00375\ \ \ \ \ debugmalloc\_insert(newentry);}
\DoxyCodeLine{00376\ \ \ \ \ \textcolor{keywordflow}{return}\ newentry-\/>user\_mem;}
\DoxyCodeLine{00377\ \}}
\DoxyCodeLine{00378\ }
\DoxyCodeLine{00379\ }
...
\DoxyCodeLine{00383\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_free\_inner(DebugmallocEntry\ *deleted)\ \{}
\DoxyCodeLine{00384\ \ \ \ \ debugmalloc\_remove(deleted);}
\DoxyCodeLine{00385\ }
\DoxyCodeLine{00386\ \ \ \ \ \textcolor{comment}{/*\ fill\ with\ garbage,\ then\ remove\ from\ linked\ list\ */}}
\DoxyCodeLine{00387\ \ \ \ \ memset(deleted-\/>real\_mem,\ debugmalloc\_canary\_char,\ deleted-\/>size\ +\ 2\ *\ debugmalloc\_canary\_size);}
\DoxyCodeLine{00388\ \ \ \ \ free(deleted-\/>real\_mem);}
\DoxyCodeLine{00389\ \ \ \ \ free(deleted);}
\DoxyCodeLine{00390\ \}}
\DoxyCodeLine{00391\ }
\DoxyCodeLine{00392\ }
...
\DoxyCodeLine{00396\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ debugmalloc\_free\_full(\textcolor{keywordtype}{void}\ *mem,\ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *func,\ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *file,\ \textcolor{keywordtype}{unsigned}\ line)\ \{}
...
\DoxyCodeLine{00402\ \ \ \ \ DebugmallocEntry\ *deleted\ =\ debugmalloc\_find(mem);}
\DoxyCodeLine{00403\ \ \ \ \ \textcolor{keywordflow}{if}\ (deleted\ ==\ NULL)\ \{}
\DoxyCodeLine{00404\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ olyan\ teruletet\ probalsz\ felszabaditani,\ ami\ nincs\ lefoglalva!\(\backslash\)n"{}},\ func,\ file,\ line);}
\DoxyCodeLine{00405\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00406\ \ \ \ \ \}}
\DoxyCodeLine{00407\ }
\DoxyCodeLine{00408\ \ \ \ \ \textcolor{comment}{/*\ check\ canary\ and\ then\ free\ memory\ */}}
\DoxyCodeLine{00409\ \ \ \ \ \textcolor{keywordflow}{if}\ (!debugmalloc\_canary\_ok(deleted))\ \{}
\DoxyCodeLine{00410\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ a\ \%p\ memoriateruletet\ tulindexelted!\(\backslash\)n"{}},\ func,\ file,\ line,\ mem);}
\DoxyCodeLine{00411\ \ \ \ \ \ \ \ \ debugmalloc\_dump\_elem(deleted);}
\DoxyCodeLine{00412\ \ \ \ \ \}}
\DoxyCodeLine{00413\ \ \ \ \ debugmalloc\_free\_inner(deleted);}
\DoxyCodeLine{00414\ \}}
\DoxyCodeLine{00415\ }
\DoxyCodeLine{00416\ }
...
\DoxyCodeLine{00421\ \ \ \ \ \ \ \ \ debugmalloc\_free\_full(oldmem,\ func,\ file,\ line);}
...
\DoxyCodeLine{00426\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ debugmalloc\_malloc\_full(newsize,\ func,\ expr,\ file,\ line,\ 0);}
\DoxyCodeLine{00427\ }
\DoxyCodeLine{00428\ \ \ \ \ \textcolor{comment}{/*\ find\ old\ allocation.\ abort\ if\ not\ found.\ */}}
\DoxyCodeLine{00429\ \ \ \ \ DebugmallocEntry\ *oldentry\ =\ debugmalloc\_find(oldmem);}
\DoxyCodeLine{00430\ \ \ \ \ \textcolor{keywordflow}{if}\ (oldentry\ ==\ NULL)\ \{}
\DoxyCodeLine{00431\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ olyan\ teruletet\ probalsz\ atmeretezni,\ ami\ nincs\ lefoglalva!\(\backslash\)n"{}},\ func,\ file,\ line);}
\DoxyCodeLine{00432\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00433\ \ \ \ \ \}}
\DoxyCodeLine{00434\ }
\DoxyCodeLine{00435\ \ \ \ \ \textcolor{comment}{/*\ create\ new\ allocation,\ copy\ \&\ free\ old\ data\ */}}
\DoxyCodeLine{00436\ \ \ \ \ \textcolor{keywordtype}{void}\ *newmem\ =\ debugmalloc\_malloc\_full(newsize,\ func,\ expr,\ file,\ line,\ \textcolor{keyword}{false});}
\DoxyCodeLine{00437\ \ \ \ \ \textcolor{keywordflow}{if}\ (newmem\ ==\ NULL)\ \{}
\DoxyCodeLine{00438\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ \%s\ @\ \%s:\%u:\ nem\ sikerult\ uj\ memoriat\ foglalni\ az\ atmeretezeshez!\(\backslash\)n"{}},\ func,\ file,\ line);}
...
\DoxyCodeLine{00441\ \ \ \ \ \}}
\DoxyCodeLine{00442\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ smaller\ =\ oldentry-\/>size\ <\ newsize\ ?\ oldentry-\/>size\ :\ newsize;}
\DoxyCodeLine{00443\ \ \ \ \ memcpy(newmem,\ oldmem,\ smaller);}
\DoxyCodeLine{00444\ \ \ \ \ debugmalloc\_free\_inner(oldentry);}
\DoxyCodeLine{00445\ }
...
\DoxyCodeLine{00451\ \textcolor{keyword}{static}\ DebugmallocData\ *\ debugmalloc\_create(\textcolor{keywordtype}{void})\ \{}
\DoxyCodeLine{00452\ \ \ \ \ \textcolor{comment}{/*\ config\ check\ */}}
\DoxyCodeLine{00453\ \ \ \ \ \textcolor{keywordflow}{if}\ (debugmalloc\_canary\_size\ \%\ 16\ !=\ 0)\ \{}
\DoxyCodeLine{00454\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ a\ kanari\ merete\ legyen\ 16-\/tal\ oszthato\(\backslash\)n"{}});}
\DoxyCodeLine{00455\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00456\ \ \ \ \ \}}
\DoxyCodeLine{00457\ \ \ \ \ \textcolor{keywordflow}{if}\ (debugmalloc\_canary\_char\ ==\ 0)\ \{}
\DoxyCodeLine{00458\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ a\ kanari\ legyen\ 0-\/tol\ kulonbozo\(\backslash\)n"{}});}
\DoxyCodeLine{00459\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00460\ \ \ \ \ \}}
\DoxyCodeLine{00461\ \ \ \ \ \textcolor{comment}{/*\ avoid\ compiler\ warning\ if\ these\ functions\ are\ not\ used\ */}}
\DoxyCodeLine{00462\ \ \ \ \ (void)\ debugmalloc\_realloc\_full;}
\DoxyCodeLine{00463\ \ \ \ \ (void)\ debugmalloc\_log\_file;}
\DoxyCodeLine{00464\ \ \ \ \ (void)\ debugmalloc\_max\_block\_size;}
\DoxyCodeLine{00465\ }
\DoxyCodeLine{00466\ \ \ \ \ \textcolor{comment}{/*\ create\ and\ initialize\ instance\ */}}
\DoxyCodeLine{00467\ \ \ \ \ DebugmallocData\ *instance\ =\ (DebugmallocData\ *)\ malloc(\textcolor{keyword}{sizeof}(DebugmallocData));}
\DoxyCodeLine{00468\ \ \ \ \ \textcolor{keywordflow}{if}\ (instance\ ==\ NULL)\ \{}
\DoxyCodeLine{00469\ \ \ \ \ \ \ \ \ debugmalloc\_log(\textcolor{stringliteral}{"{}debugmalloc:\ nem\ sikerult\ elinditani\ a\ memoriakezelest\(\backslash\)n"{}});}
\DoxyCodeLine{00470\ \ \ \ \ \ \ \ \ abort();}
\DoxyCodeLine{00471\ \ \ \ \ \}}
\DoxyCodeLine{00472\ \ \ \ \ debugmalloc\_strlcpy(instance-\/>logfile,\ \textcolor{stringliteral}{"{}"{}},\ \textcolor{keyword}{sizeof}(instance-\/>logfile));}
\DoxyCodeLine{00473\ \ \ \ \ instance-\/>max\_block\_size\ =\ debugmalloc\_max\_block\_size\_default;}
\DoxyCodeLine{00474\ \ \ \ \ instance-\/>alloc\_count\ =\ 0;}
\DoxyCodeLine{00475\ \ \ \ \ instance-\/>alloc\_bytes\ =\ 0;}
\DoxyCodeLine{00476\ \ \ \ \ instance-\/>all\_alloc\_count\ =\ 0;}
\DoxyCodeLine{00477\ \ \ \ \ instance-\/>all\_alloc\_bytes\ =\ 0;}
\DoxyCodeLine{00478\ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{size\_t}\ i\ =\ 0;\ i\ <\ debugmalloc\_tablesize;\ i++)\ \{}
\DoxyCodeLine{00479\ \ \ \ \ \ \ \ \ instance-\/>head[i].prev\ =\ NULL;}
\DoxyCodeLine{00480\ \ \ \ \ \ \ \ \ instance-\/>head[i].next\ =\ \&instance-\/>tail[i];}
\DoxyCodeLine{00481\ \ \ \ \ \ \ \ \ instance-\/>tail[i].next\ =\ NULL;}
\DoxyCodeLine{00482\ \ \ \ \ \ \ \ \ instance-\/>tail[i].prev\ =\ \&instance-\/>head[i];}
\DoxyCodeLine{00483\ \ \ \ \ \}}
\DoxyCodeLine{00484\ }
\DoxyCodeLine{00485\ \ \ \ \ atexit(debugmalloc\_atexit\_dump);}
...
\DoxyCodeLine{00508\ \ }
\DoxyCodeLine{00509\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{char}\ *\ debugmalloc\_strdup\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *s,\ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *func,\ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *expr,\ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}\ *file,\ \textcolor{keywordtype}{unsigned}\ line)}
\DoxyCodeLine{00510\ \{}
\DoxyCodeLine{00511\ \ \ \textcolor{keywordtype}{size\_t}\ len\ =\ strlen\ (s)\ +\ 1;}
\DoxyCodeLine{00512\ \ \ \textcolor{keywordtype}{void}\ *\textcolor{keyword}{new}\ =\ debugmalloc\_malloc\_full\ (len,\ func,\ expr,\ file,\ line,\ 0);}
\DoxyCodeLine{00513\ }
...
\DoxyCodeLine{00527\ \ \ }
\DoxyCodeLine{00528\ \ \ \textcolor{keywordtype}{void}\ *\textcolor{keyword}{new}\ =\ debugmalloc\_malloc\_full\ (len+1,\ func,\ expr,\ file,\ line,\ 0);}
\DoxyCodeLine{00529\ }
